...
The tensors must match the specified feature representation, including
...
Runtime feature packs and gate weights use non-pickled NPZ. Training also
writes PyTorch validation checkpoints; load only trusted checkpoints.
...
The final TL channel uses radius-2, 2048-bit Morgan similarity.
